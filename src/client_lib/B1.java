...
public class B1 extends ClientConnectionHandler {
	...
	public String procedure_0() {
		...
		String transactionId = System.currentTimeMillis() + "B" + "1" + "procedure_0"
				+ parameterTypeList.toString();

		ClientToServerMsg clientToServerMsg = new ClientToServerMsg(clientAddress, "B", "1",
				"procedure_0", parameterTypeList, parameterValueList, transactionId);

		ClientToMapperMsg clientToMapperMsg = new ClientToMapperMsg(clientAddress, "B", "1",
	...
	public double[][] multiply(double[][] a, double[][] b) {
		...
		String transactionId = System.currentTimeMillis() + "B" + "1" + "multiply"
				+ parameterTypeList.toString();
	...
	public double min(double[] a) {
		...
		ArrayList<Object> parameterValueList = new ArrayList<>();
		parameterValueList.add(a);
		String transactionId = System.currentTimeMillis() + "B" + "1" + "min"
				+ parameterTypeList.toString();

		ClientToServerMsg clientToServerMsg = new ClientToServerMsg(clientAddress, "B", "1", "min",
				parameterTypeList, parameterValueList, transactionId);

		ClientToMapperMsg clientToMapperMsg = new ClientToMapperMsg(clientAddress, "B", "1", "min",
				parameterTypeList);
		try {
